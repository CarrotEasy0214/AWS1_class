...
const setView = (idx) => {
  titleElem.innerHTML = list[idx].getTitle();
  writerElem.innerHTML = list[idx].getWriter();
  createdAtElem.innerHTML = list[idx].getCreatedAt();
  contentElem.innerHTML = list[idx].getContent();
};
