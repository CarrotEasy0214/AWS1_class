...
cateListElem.innerHTML += `<option value="0">채널선택</option>`;
const tempArr = [];
...
const writeForm = document.forms.write;
console.log(writeForm);

writeForm.onsubmit = (e) => {
  e.prventeDeafault();
  console.log(writeForm.title.value);
  console.log(writeForm.content.value);
